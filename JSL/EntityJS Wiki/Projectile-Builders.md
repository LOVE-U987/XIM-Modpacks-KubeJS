...
All projectile entity textures should be stored in the following directory structure:

```
kubejs/assets/modid/textures/entity/projectiles/projectile.png
```

For example, if your projectile is named `kubejs:fireball`, the texture should be located at:

```
kubejs/assets/kubejs/textures/entity/projectiles/fireball.png
```
